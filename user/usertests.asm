...
0000000000001390 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    144e:	0ee78793          	addi	a5,a5,238 # 8538 <malloc+0x253e>
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45de:	58650513          	addi	a0,a0,1414 # 6b60 <malloc+0xb66>
    45e2:	00002097          	auipc	ra,0x2
    45e6:	960080e7          	jalr	-1696(ra) # 5f42 <printf>
    exit(1);
    45ea:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    460c:	39850513          	addi	a0,a0,920 # 69a0 <malloc+0x9a6>
    4610:	00002097          	auipc	ra,0x2
    4614:	932080e7          	jalr	-1742(ra) # 5f42 <printf>
    exit(1);
    4618:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4650:	b3c58593          	addi	a1,a1,-1220 # 6188 <malloc+0x18e>
    ...
    467a:	32a50513          	addi	a0,a0,810 # 69a0 <malloc+0x9a6>
    467e:	00002097          	auipc	ra,0x2
    4682:	8c4080e7          	jalr	-1852(ra) # 5f42 <printf>
     exit(1);
    4686:	4505                	li	a0,1
    ...
    4696:	61e50513          	addi	a0,a0,1566 # 7cb0 <malloc+0x1cb6>
    469a:	00002097          	auipc	ra,0x2
    469e:	8a8080e7          	jalr	-1880(ra) # 5f42 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d2:	5fa50513          	addi	a0,a0,1530 # 7cc8 <malloc+0x1cce>
    46d6:	00002097          	auipc	ra,0x2
    46da:	86c080e7          	jalr	-1940(ra) # 5f42 <printf>
}
  ...
  printf("kill... ");
    ...
    46fe:	5e650513          	addi	a0,a0,1510 # 7ce0 <malloc+0x1ce6>
    4702:	00002097          	auipc	ra,0x2
    4706:	840080e7          	jalr	-1984(ra) # 5f42 <printf>
  kill(pid1);
    470a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    472c:	5c850513          	addi	a0,a0,1480 # 7cf0 <malloc+0x1cf6>
    4730:	00002097          	auipc	ra,0x2
    4734:	812080e7          	jalr	-2030(ra) # 5f42 <printf>
  wait(0);
    4738:	4501                	li	a0,0
...
0000000000004758 <reparent>:
{
  ...
  exit(0);
    ...
    47ac:	1f850513          	addi	a0,a0,504 # 69a0 <malloc+0x9a6>
    47b0:	00001097          	auipc	ra,0x1
    47b4:	792080e7          	jalr	1938(ra) # 5f42 <printf>
      exit(1);
    47b8:	4505                	li	a0,1
    ...
    47c8:	36450513          	addi	a0,a0,868 # 6b28 <malloc+0xb2e>
    47cc:	00001097          	auipc	ra,0x1
    47d0:	776080e7          	jalr	1910(ra) # 5f42 <printf>
        exit(1);
    47d4:	4505                	li	a0,1
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    483e:	26e50513          	addi	a0,a0,622 # 6aa8 <malloc+0xaae>
    4842:	00001097          	auipc	ra,0x1
    4846:	700080e7          	jalr	1792(ra) # 5f42 <printf>
    exit(1);
    484a:	4505                	li	a0,1
    ...
    4872:	91a58593          	addi	a1,a1,-1766 # 6188 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4936:	3ce50513          	addi	a0,a0,974 # 7d00 <malloc+0x1d06>
    493a:	00001097          	auipc	ra,0x1
    493e:	608080e7          	jalr	1544(ra) # 5f42 <printf>
    exit(1);
    4942:	4505                	li	a0,1
    ...
    4952:	05250513          	addi	a0,a0,82 # 69a0 <malloc+0x9a6>
    4956:	00001097          	auipc	ra,0x1
    495a:	5ec080e7          	jalr	1516(ra) # 5f42 <printf>
    exit(1);
    495e:	4505                	li	a0,1
    ...
    499e:	38650513          	addi	a0,a0,902 # 7d20 <malloc+0x1d26>
    49a2:	00001097          	auipc	ra,0x1
    49a6:	5a0080e7          	jalr	1440(ra) # 5f42 <printf>
    exit(1);
    49aa:	4505                	li	a0,1
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a08:	5f6080e7          	jalr	1526(ra) # 5ffa <malloc>
    ...
    4a42:	31250513          	addi	a0,a0,786 # 7d50 <malloc+0x1d56>
    4a46:	00001097          	auipc	ra,0x1
    4a4a:	4fc080e7          	jalr	1276(ra) # 5f42 <printf>
      exit(1);
    4a4e:	4505                	li	a0,1
...
0000000000004a62 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4af8:	28c50513          	addi	a0,a0,652 # 7d80 <malloc+0x1d86>
    4afc:	00001097          	auipc	ra,0x1
    4b00:	446080e7          	jalr	1094(ra) # 5f42 <printf>
    exit(1);
    4b04:	4505                	li	a0,1
    ...
    4b14:	29850513          	addi	a0,a0,664 # 7da8 <malloc+0x1dae>
    4b18:	00001097          	auipc	ra,0x1
    4b1c:	42a080e7          	jalr	1066(ra) # 5f42 <printf>
      exit(1);
    4b20:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	21c50513          	addi	a0,a0,540 # 7d70 <malloc+0x1d76>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b98:	23450513          	addi	a0,a0,564 # 7dc8 <malloc+0x1dce>
    4b9c:	00001097          	auipc	ra,0x1
    4ba0:	3a6080e7          	jalr	934(ra) # 5f42 <printf>
    exit(1);
    4ba4:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bd4:	1a050513          	addi	a0,a0,416 # 7d70 <malloc+0x1d76>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfa:	1fa50513          	addi	a0,a0,506 # 7df0 <malloc+0x1df6>
    4bfe:	00001097          	auipc	ra,0x1
    4c02:	344080e7          	jalr	836(ra) # 5f42 <printf>
    exit(1);
    4c06:	4505                	li	a0,1
...
0000000000004c1a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c40:	1cc78793          	addi	a5,a5,460 # 7e08 <malloc+0x1e0e>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	1c878793          	addi	a5,a5,456 # 7e10 <malloc+0x1e16>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	1c478793          	addi	a5,a5,452 # 7e18 <malloc+0x1e1e>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	1c078793          	addi	a5,a5,448 # 7e20 <malloc+0x1e26>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cdc:	0d050513          	addi	a0,a0,208 # 6da8 <malloc+0xdae>
    4ce0:	00001097          	auipc	ra,0x1
    4ce4:	262080e7          	jalr	610(ra) # 5f42 <printf>
      exit(1);
    4ce8:	4505                	li	a0,1
    ...
    4d58:	0d450513          	addi	a0,a0,212 # 7e28 <malloc+0x1e2e>
    4d5c:	00001097          	auipc	ra,0x1
    4d60:	1e6080e7          	jalr	486(ra) # 5f42 <printf>
        exit(1);
    4d64:	4505                	li	a0,1
    ...
    4d72:	0ca50513          	addi	a0,a0,202 # 7e38 <malloc+0x1e3e>
    4d76:	00001097          	auipc	ra,0x1
    4d7a:	1cc080e7          	jalr	460(ra) # 5f42 <printf>
          exit(1);
    4d7e:	4505                	li	a0,1
    ...
    4d9a:	0ba50513          	addi	a0,a0,186 # 7e50 <malloc+0x1e56>
    4d9e:	00001097          	auipc	ra,0x1
    4da2:	1a4080e7          	jalr	420(ra) # 5f42 <printf>
          exit(1);
    4da6:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e28:	03c50513          	addi	a0,a0,60 # 7e60 <malloc+0x1e66>
    4e2c:	00001097          	auipc	ra,0x1
    4e30:	116080e7          	jalr	278(ra) # 5f42 <printf>
      exit(1);
    4e34:	4505                	li	a0,1
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8a:	ff2b8b93          	addi	s7,s7,-14 # 7e78 <malloc+0x1e7e>
  for(i = 0; i < N; i++){
    ...
    4ecc:	fb850513          	addi	a0,a0,-72 # 7e80 <malloc+0x1e86>
    4ed0:	00001097          	auipc	ra,0x1
    4ed4:	072080e7          	jalr	114(ra) # 5f42 <printf>
        exit(1);
    4ed8:	4505                	li	a0,1
    ...
    4eea:	f9250513          	addi	a0,a0,-110 # 7e78 <malloc+0x1e7e>
  ...
  fd = open(".", 0);
    ...
    4f22:	8e250513          	addi	a0,a0,-1822 # 6800 <malloc+0x806>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9a:	f0a50513          	addi	a0,a0,-246 # 7ea0 <malloc+0x1ea6>
    4f9e:	00001097          	auipc	ra,0x1
    4fa2:	fa4080e7          	jalr	-92(ra) # 5f42 <printf>
        exit(1);
    4fa6:	4505                	li	a0,1
    ...
    4fba:	f0a50513          	addi	a0,a0,-246 # 7ec0 <malloc+0x1ec6>
    4fbe:	00001097          	auipc	ra,0x1
    4fc2:	f84080e7          	jalr	-124(ra) # 5f42 <printf>
        exit(1);
    4fc6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4ff2:	efa50513          	addi	a0,a0,-262 # 7ee8 <malloc+0x1eee>
    4ff6:	00001097          	auipc	ra,0x1
    4ffa:	f4c080e7          	jalr	-180(ra) # 5f42 <printf>
    exit(1);
    4ffe:	4505                	li	a0,1
    ...
    500e:	99650513          	addi	a0,a0,-1642 # 69a0 <malloc+0x9a6>
    5012:	00001097          	auipc	ra,0x1
    5016:	f30080e7          	jalr	-208(ra) # 5f42 <printf>
      exit(1);
    501a:	4505                	li	a0,1
...
00000000000051b8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	ce450513          	addi	a0,a0,-796 # 7f20 <malloc+0x1f26>
  ...
  for(i = 0; ; i++){
    ...
    52a4:	c9050513          	addi	a0,a0,-880 # 7f30 <malloc+0x1f36>
    52a8:	00001097          	auipc	ra,0x1
    52ac:	c9a080e7          	jalr	-870(ra) # 5f42 <printf>
    exit(1);
    52b0:	4505                	li	a0,1
    ...
    52c0:	c9450513          	addi	a0,a0,-876 # 7f50 <malloc+0x1f56>
    52c4:	00001097          	auipc	ra,0x1
    52c8:	c7e080e7          	jalr	-898(ra) # 5f42 <printf>
      exit(1);
    52cc:	4505                	li	a0,1
    ...
    52dc:	c9850513          	addi	a0,a0,-872 # 7f70 <malloc+0x1f76>
    52e0:	00001097          	auipc	ra,0x1
    52e4:	c62080e7          	jalr	-926(ra) # 5f42 <printf>
    exit(1);
    52e8:	4505                	li	a0,1
    ...
    52f8:	c9c50513          	addi	a0,a0,-868 # 7f90 <malloc+0x1f96>
    52fc:	00001097          	auipc	ra,0x1
    5300:	c46080e7          	jalr	-954(ra) # 5f42 <printf>
      exit(1);
    5304:	4505                	li	a0,1
    ...
    5314:	ca050513          	addi	a0,a0,-864 # 7fb0 <malloc+0x1fb6>
    5318:	00001097          	auipc	ra,0x1
    531c:	c2a080e7          	jalr	-982(ra) # 5f42 <printf>
      exit(1);
    5320:	4505                	li	a0,1
    ...
    5330:	c9c50513          	addi	a0,a0,-868 # 7fc8 <malloc+0x1fce>
    5334:	00001097          	auipc	ra,0x1
    5338:	c0e080e7          	jalr	-1010(ra) # 5f42 <printf>
      exit(1);
    533c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    535e:	bc650513          	addi	a0,a0,-1082 # 7f20 <malloc+0x1f26>
    ...
    5382:	c6a50513          	addi	a0,a0,-918 # 7fe8 <malloc+0x1fee>
    5386:	00001097          	auipc	ra,0x1
    538a:	bbc080e7          	jalr	-1092(ra) # 5f42 <printf>
    exit(1);
    538e:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cb0:	90c50513          	addi	a0,a0,-1780 # 85b8 <digits>
    5cb4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d70:	7f4c8c93          	addi	s9,s9,2036 # 8560 <malloc+0x2566>
  ...
  putc(fd, 'x');
    ...
    5d7e:	83eb8b93          	addi	s7,s7,-1986 # 85b8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ea4:	6b898993          	addi	s3,s3,1720 # 8558 <malloc+0x255e>
        while(*s != 0){
    5ea8:	85ee                	mv	a1,s11
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5f86:	4ce7b783          	ld	a5,1230(a5) # 9450 <freep>
    ...
    5fae:	00e6ea63          	bltu	a3,a4,5fc2 <free+0x4a>
{
  ...
  freep = p;
    ...
    5ff0:	46f73223          	sd	a5,1124(a4) # 9450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    6022:	43253503          	ld	a0,1074(a0) # 9450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    604a:	40a90913          	addi	s2,s2,1034 # 9450 <freep>
  if(p == (char*)-1)
    604e:	5afd                	li	s5,-1
    6050:	a895                	j	60c4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6052:	0000a797          	auipc	a5,0xa
    6056:	c2678793          	addi	a5,a5,-986 # fc78 <base>
    605a:	00003717          	auipc	a4,0x3
    605e:	3ef73b23          	sd	a5,1014(a4) # 9450 <freep>
    ...
    6086:	3ca73723          	sd	a0,974(a4) # 9450 <freep>
      return (void*)(p + 1);
